...
const (
	EmailDigestImmediate = "immediate"
	EmailDigestDaily     = "daily"
	EmailDigestWeekly    = "weekly"
	EmailDigestNever     = "never"
)

// EmailDigestModes must stay in step with the users.email_digest CHECK constraint.
var EmailDigestModes = []string{EmailDigestImmediate, EmailDigestDaily, EmailDigestWeekly, EmailDigestNever}
