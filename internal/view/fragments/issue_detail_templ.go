...
func IssueDetail(data view.IssueDetailFragData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.Issue.State == "open" {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.ResolveAttributeValue("/api/repos/" + data.Owner + "/" + data.Repo + "/issues/" + strconv.Itoa(data.Issue.Number))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(`{"state":"closed"}`)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue("/api/repos/" + data.Owner + "/" + data.Repo + "/issues/" + strconv.Itoa(data.Issue.Number))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.ResolveAttributeValue(`{"state":"open"}`)
			if templ_7745c5c3_Err != nil {
