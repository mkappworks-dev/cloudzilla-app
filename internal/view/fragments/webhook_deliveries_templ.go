...
func WebhookDeliveriesList(data view.WebhookDeliveriesFragData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs("webhook-deliveries-" + strconv.FormatInt(data.WebhookID, 10))
		if templ_7745c5c3_Err != nil {
		...
		if len(data.Deliveries) > 0 {
			for _, d := range data.Deliveries {
				...
				if data.CanManage {
					...
					templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs("/api/repos/" + data.Owner + "/" + data.RepoName + "/hooks/" + strconv.FormatInt(data.WebhookID, 10) + "/redeliver?delivery_id=" + strconv.FormatInt(d.ID, 10))
					if templ_7745c5c3_Err != nil {
