...
func RepoLabels(data view.RepoLabelsFragData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.CanWrite {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs("/api/repos/" + data.Owner + "/" + data.RepoName + "/labels")
			if templ_7745c5c3_Err != nil {
		...
		if len(data.Labels) > 0 {
			for _, lbl := range data.Labels {
				...
				if data.CanWrite {
					...
					templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs("/api/repos/" + data.Owner + "/" + data.RepoName + "/labels/" + strconv.FormatInt(lbl.ID, 10))
					if templ_7745c5c3_Err != nil {
