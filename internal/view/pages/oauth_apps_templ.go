		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Apps) > 0 {
				...
				for _, app := range data.Apps {
					...
					templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs("/api/oauth/apps/" + strconv.FormatInt(app.ID, 10))
					if templ_7745c5c3_Err != nil {
			...
			if len(data.Authorizations) > 0 {
				...
				for _, auth := range data.Authorizations {
					...
					templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs("/api/oauth/authorizations/" + strconv.FormatInt(auth.ID, 10))
					if templ_7745c5c3_Err != nil {
