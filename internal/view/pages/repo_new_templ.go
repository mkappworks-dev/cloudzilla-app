...
func RepoNew(data view.RepoNewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = repoNewCustomSelect("repo-owner", "owner", ownerOpts, repoNewSelectOption{Value: initialOwner, Label: initialOwner}).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" class=\"w-full bg-background border border-border rounded-md px-2.5 py-2 text-[13px] text-foreground font-mono placeholder:text-muted-foreground/70 focus:outline-none focus:border-ring\"></div></div><p class=\"text-[12px] text-muted-foreground/70 -mt-3\">Great repository names are short and memorable. Need inspiration? <span class=\"font-mono\">turbo-octo-meme</span>.</p><div><label for=\"repo-description\" class=\"block text-[12px] font-medium text-muted-foreground mb-1.5\">Description <span class=\"text-muted-foreground/70 font-normal\">(optional)</span></label> <textarea id=\"repo-description\" name=\"description\" rows=\"2\" placeholder=\"A short description of your project\" class=\"w-full bg-background border border-border rounded-md px-2.5 py-2 text-[13px] text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:border-ring\"></textarea></div><fieldset><legend class=\"text-[12px] font-medium text-muted-foreground mb-2\">Visibility</legend> <label class=\"border border-border rounded-md p-3 flex items-start gap-3 mb-2 cursor-pointer hover:bg-accent\"><input type=\"radio\" name=\"visibility\" value=\"public\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func repoNewCustomSelect(id, name string, options []repoNewSelectOption, initial repoNewSelectOption) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, opt := range options {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/view/pages/repo_new.templ`, Line: 192, Col: 49}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/view/pages/repo_new.templ`, Line: 192, Col: 74}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var14)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 24, "\" @click=\"value=$el.dataset.value; label=$el.dataset.label; open=false\" :class=\"{ 'bg-accent text-foreground': value === $el.dataset.value }\" :aria-selected=\"value === $el.dataset.value ? 'true' : 'false'\" role=\"option\" class=\"w-full text-left px-2 py-1.5 text-[13px] rounded hover:bg-accent\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/view/pages/repo_new.templ`, Line: 193, Col: 17}
			}
