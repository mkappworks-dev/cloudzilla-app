...
- [ ] Create `migrations/046_create_gists.sql`:
...
- [ ] Edit `internal/router/router.go`:
  ...
  1. Add page names `"gists"`, `"gist_new"`, `"gist_detail"`, `"gist_edit"`, `"user_gists"` to the `pageNames` slice.

  2. Add routes before the Git HTTP section:
...
- [ ] `migrations/046_create_gists.sql`
...
- [ ] `internal/router/router.go` (pageNames + routes)
