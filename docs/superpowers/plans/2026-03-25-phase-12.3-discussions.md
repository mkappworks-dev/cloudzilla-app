...
| File | Action | Purpose |
|---|---|---|
| `internal/db/migrations/046_create_discussions.sql` | Create | Three tables + indexes + deferred FK |
...
- [ ] Step 1: Create `internal/db/migrations/046_create_discussions.sql`:
