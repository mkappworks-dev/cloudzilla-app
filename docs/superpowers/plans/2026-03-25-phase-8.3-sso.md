...
- [ ] Create a pull request: `gh pr create --base main --head tech/phase-8.3-sso --title "feat(phase-8.3): add LDAP and SAML SSO authentication" --body "Adds LDAP and SAML SSO authentication support with per-provider config, auto-provisioning, and a superadmin settings page."`
